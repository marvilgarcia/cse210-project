...
public class ScriptureLibrary
{
    ...
    private void InitializeLibrary()
    {
        ...
        _scriptures.Add(new Scripture(new Reference("Matthew", 5, 16),  "O that cunning plan of the evil one! O the vainness, and the frailties, and the foolishness of men! When they are learned they think they are wise, and they hearken not unto the counsel of God, for they set it aside, supposing they know of themselves, wherefore, their wisdom is foolishness and it profiteth them not. And they shall perish.n/But to be learned is good if they hearken unto the counsels of God."));
